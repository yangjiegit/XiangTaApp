...
import static com.blankj.utilcode.util.ConvertUtils.bits2Bytes;
import static com.blankj.utilcode.util.ConvertUtils.byte2FitMemorySize;
import static com.blankj.utilcode.util.ConvertUtils.byte2MemorySize;
import static com.blankj.utilcode.util.ConvertUtils.bytes2Bits;
import static com.blankj.utilcode.util.ConvertUtils.bytes2Chars;
import static com.blankj.utilcode.util.ConvertUtils.bytes2HexString;
import static com.blankj.utilcode.util.ConvertUtils.bytes2InputStream;
import static com.blankj.utilcode.util.ConvertUtils.chars2Bytes;
import static com.blankj.utilcode.util.ConvertUtils.hexString2Bytes;
import static com.blankj.utilcode.util.ConvertUtils.inputStream2Bytes;
import static com.blankj.utilcode.util.ConvertUtils.inputStream2String;
import static com.blankj.utilcode.util.ConvertUtils.millis2FitTimeSpan;
import static com.blankj.utilcode.util.ConvertUtils.string2InputStream;
