...
jclass renderClass;
jmethodID renderYuvFrameMethod;
...
public:
    virtual bool onCaptureVideoFrame(VideoFrame &videoFrame) override {
        ...
        if (g_buffer_length == 0 || g_buffer_length != len) {
            ...
            renderYuvFrameMethod = env->GetStaticMethodID(renderClass, "renderYuvFrame", "(III)I");
        ...
        writeLog("start to renderYuvFrameMethod");
        int ret = env->CallStaticIntMethod(renderClass, renderYuvFrameMethod,
...
JNIEXPORT void JNICALL Java_com_shiyu_tisdk_VideoPreProcessing_enablePreProcessing
    ...
    renderClass = env->FindClass("com/muse/tisdk/AGRender");
