...
public abstract class BaseListFragment2<T> extends BaseFragment implements BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.OnItemChildClickListener {
    ...
    protected View getBaseView(LayoutInflater inflater, ViewGroup container) {
        return inflater.inflate(R.layout.fragment_base_list2, container, false);
    }
    ...
    protected void initView(View view) {
        ...
        mSwRefresh.setColorSchemeColors(getResources().getColor(R.color.transparent));
