...
import com.muse.xiangta.event.BGEventObserver;
import com.muse.xiangta.event.BaseEvent;
...
import com.muse.xiangta.inter.MenuDialogClick;
...
import com.muse.xiangta.ui.CuckooVideoCallWaitActivity;
 ...
 * 基础Activity类
 */
public abstract class BaseActivity2 extends FragmentActivity implements RtcEngineEventHandler, View.OnClickListener, BGEventObserver {
    ...
    private void initBar() {
        mTopBar.setBackgroundResource(R.color.admin_color);
    ...
    public void onGlobalVideoCallEvent(EImVideoCallMessages var1) {
        ...
        LogUtils.i("一对一通话", "收到消息一对一视频请求消息:" + var1.msg.getCustomMsg().getSender().getUser_nickname());

        try {

            CuckooVideoCallWaitActivity.start(this, var1.msg.getCustomMsg());
