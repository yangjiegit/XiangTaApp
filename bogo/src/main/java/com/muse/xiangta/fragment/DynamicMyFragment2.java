 ...
 * 动态 关注
 */
public class DynamicMyFragment2 extends BaseListFragment<DynamicListModel> implements BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.OnItemChildClickListener {

    private String toUserId;

    public static DynamicMyFragment2 getInstance(String toUserId) {
        DynamicMyFragment2 dynamicMyFragment = new DynamicMyFragment2();
