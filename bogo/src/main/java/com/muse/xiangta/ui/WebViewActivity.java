...
import com.muse.xiangta.utils.JavaScriptInterface;
import com.muse.xiangta.webview.config.CuckooWebChromeClient;
import com.muse.xiangta.webview.config.CuckooWebViewClient;
import com.muse.xiangta.webview.config.FullscreenHolder;
import com.muse.xiangta.webview.config.IWebPageView;
import com.muse.xiangta.webview.config.ImageClickInterface;
...
//        getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
    ...
    private void getIntentData() {
        if (getIntent() != null) {
            ...
            if(TextUtils.isEmpty(mUrl))mUrl= ConfigModel.getInitData().getApp_h5().getAbout_me();
            if (isToken) {
