...
import com.muse.xiangta.widget.FullScreenVideoView;
...
public class RegisterSelectActivity extends BaseActivity implements PlatformActionListener {
    ...
    protected void initSet() {
        ...
        phoneNumberEdtext.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (com.muse.xiangta.utils.Utils.isMobile(s.toString())) {
    ...
    private void doPhoneLogin(String mobile, String code, String agent) {
        Api.userLogin(mobile, code, inviteCode, agent, com.muse.xiangta.utils.Utils.getUUID(), new JsonCallback() {
            @Override
    ...
    private void doPlatLogin(String platId) {
        ...
        Api.doPlatAuthLogin(platId, inviteCode, "",com.muse.xiangta.utils.Utils.getUUID(),0, new JsonCallback() {
            @Override
            public Context getContextToJson() {
                return getNowContext();
            }
    ...
    private void doSendCode() {
        if (com.muse.xiangta.utils.Utils.isMobile(phoneNumberEdtext.getText().toString())) {
