...
import com.muse.xiangta.adapter.PayMenuAdapter;
import com.muse.xiangta.adapter.recycler.RecycleViewRechargeRuleAdapter;
...
public class RechargeActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener {
    ...
    private void urlPay(Pay4Bean jsonObj) {
        startActivity(new Intent(RechargeActivity.this,XWebViewActivity.class)
