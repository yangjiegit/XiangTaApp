...
public class CustomMessage2 extends Message2 {
    ...
    public CustomMessage2(CustomMsg customMsg, int type) {
     ...
     */
    @Override
    public void showMessage(ChatAdapter2.ViewHolder viewHolder, Context context) {
...
//                                iv_cai.setVisibility(View.VISIBLE);
    ...
    //私照信息
    private void setPrivateImgMsgType(ChatAdapter2.ViewHolder viewHolder, Context context, final CustomMsgPrivatePhoto customMsgPrivatePhoto) {
    ...
    //一对一视频请求消息UI填充
    private void setVideoLinMsgType(ChatAdapter2.ViewHolder viewHolder, Context context, UserModel userModel, String msg) {
    ...
    //私信送礼物UI填充数据
    private void setPrivateMsgType(ChatAdapter2.ViewHolder viewHolder, Context context, CustomMsgPrivateGift customMsgPrivateGift) {
        clearView(viewHolder);
        if (checkRevoke(viewHolder)) {
            return;
        }
