 ...
 * 小视频消息数据
 */
public class VideoMessage2 extends Message2 {

    private static final String TAG = "VideoMessage";


    public VideoMessage2(TIMMessage message) {
        this.message = message;
    }

    public VideoMessage2(String fileName) {
    ...
    public VideoMessage2(String filePath, String coverPath, long duration) {
        this.message = new TIMMessage();
        TIMVideoElem elem = new TIMVideoElem();
