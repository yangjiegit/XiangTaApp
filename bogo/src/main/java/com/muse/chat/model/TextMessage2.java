...
import com.muse.chat.utils.EmoticonUtil;
...
public class TextMessage2 extends Message2 {
    ...
    public TextMessage2(TIMMessage message) {
        this.message = message;
    }

    public TextMessage2(String s) {
    ...
    public TextMessage2(TIMMessageDraft draft) {
        message = new TIMMessage();
    ...
    public TextMessage2(Editable s) {
        message = new TIMMessage();
    ...
    public void showMessage(final ChatAdapter2.ViewHolder viewHolder, final Context context) {
        ...
        tv.setTextColor(CuckooApplication.getInstances().getResources().getColor(isSelf() ? R.color.gray_black : R.color.gray_black));
