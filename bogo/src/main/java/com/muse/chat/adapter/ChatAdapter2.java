 ...
 * 聊天界面adapter
 */
public class ChatAdapter2 extends ArrayAdapter<Message2> {
     ...
     */
    public ChatAdapter2(Context context, int resource, List<Message2> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position < getCount()) {
            final Message2 data = getItem(position);
