...
public class ConversationPresenter implements Observer {
    ...
    public void getConversation() {
        ...
        for (TIMConversation conversation : list) {
            ...
            if (conversation.getType() == TIMConversationType.Group
                    || conversation.getType() == TIMConversationType.System || conversation.getPeer().equals("admin"))
                continue;
        ...
        for (int i = 0; i < result.size(); i++) {
            ...
            TIMConversationExt conversationExt = new TIMConversationExt(result.get(i));
    ...
    public boolean delConversation(TIMConversationType type, String id) {
        return TIMManagerExt.getInstance().deleteConversation(type, id);
    }
