 ...
 */
public class TiBrowPencilAdapter extends RecyclerView.Adapter<TiMakeupItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final TiMakeupItemViewHolder holder, int position) {
        ...
        if (tiMakeup == TiMakeup.NO_MAKEUP) {
            ...
            Glide.with(holder.itemView.getContext())
                    .load(list.get(position).getImagePath(holder.itemView.getContext(), TiMakeupEnum.BROW_PENCIL_MAKEUP))
                    .into(holder.thumbIV);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tiSDKManager.setBrowPencil(list.get(holder.getAdapterPosition()).getName());
                notifyDataSetChanged();
            }
        });
    }
