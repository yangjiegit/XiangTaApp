...
public class TiEyeShadowAdapter extends RecyclerView.Adapter<TiMakeupItemViewHolder> {
    ...
    public TiEyeShadowAdapter(List<TiMakeup> list, TiSDKManager tiSDKManager) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull final TiMakeupItemViewHolder holder, int position) {
        ...
        if (tiMakeup == TiMakeup.NO_MAKEUP) {
            ...
            Glide.with(holder.itemView.getContext())
                    .load(list.get(position).getImagePath(holder.itemView.getContext(), TiMakeupEnum.EYE_SHADOW_MAKEUP))
                    .into(holder.thumbIV);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tiSDKManager.setEyeShadow(list.get(holder.getAdapterPosition()).getName());
                notifyDataSetChanged();
            }
        });
    }
